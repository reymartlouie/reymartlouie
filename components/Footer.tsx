...
export default function Footer() {
  return (
    <section id="contact" className="grid grid-cols-1 lg:grid-cols-12 gap-4 pb-6">
      ...
      {/* ── Calling card — champagne titanium ───────────────────────────── */}
      <Reveal className="lg:col-span-4" delay={80}>
        <div
          ...
          style={{
            /* Layered: angled sheen → brushed horizontal lines → champagne titanium base */
            background: `
              ...
              repeating-linear-gradient(
                ...
                rgba(255,255,255,0.000) 1.5px,
                rgba(255,255,255,0.055) 1.5px,
                rgba(255,255,255,0.055) 2px
              ),
              #cec2ae
            `,
            /* Inset edges: bright top (light catching), dark bottom (shadow) */
            boxShadow: `
          ...
          <div>
            <p
              ...
              style={{
                ...
                marginBottom: '1.5rem',
                color: '#1a1714',
                /* Engraved look: bright below, shadow above */
