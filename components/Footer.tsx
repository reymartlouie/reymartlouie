...
export default function Footer() {
  return (
    <section id="contact" className="grid grid-cols-1 lg:grid-cols-12 gap-4 pb-6">
      ...
      {/* Contact CTA card — dark muted sage */}
      <div className="lg:col-span-8 bg-[#1a2e26] rounded-[32px] p-8 lg:p-10 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#6ee7b7]/12 text-[#6ee7b7] border border-[#6ee7b7]/20 font-sans text-sm font-semibold px-6 py-3 rounded-full hover:bg-[#6ee7b7]/20 transition-colors"
          >
      ...
      {/* Social links card — dark grey */}
      <div className="lg:col-span-4 bg-[#1a1a1a] rounded-[32px] p-8 flex flex-col justify-between">
        <div>
          ...
          <div className="flex flex-col">
            {socialLinks.map((link) => (
              ...
              >
                <span className="font-sans text-white/60 text-sm group-hover:text-white transition-colors">
                  {link.label}
                </span>
                <span className="text-white/20 group-hover:text-white transition-colors text-sm">↗</span>
              </a>
            ))}
          </div>
        </div>
