    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 flex-shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div>
            <p className="font-sans text-xs uppercase tracking-widest mb-0.5" style={{ color: 'var(--fg-30)' }}>Thesis · BS Computer Engineering</p>
        ...
        {/* Scrollable body */}
        <div className="overflow-y-auto flex-1 min-h-0 p-8 md:p-10">
          ...
          {/* The Problem */}
          <div className="mb-8 p-6 rounded-[20px]" style={{ background: 'rgba(251,146,60,0.05)', border: '1px solid rgba(251,146,60,0.12)' }}>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              {hardware.map(({ label, category }) => (
                <div key={label} className="flex items-center justify-between px-4 py-3 rounded-2xl" style={{ background: 'rgba(251,146,60,0.05)', border: '1px solid rgba(251,146,60,0.10)' }}>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={env} className="flex items-center justify-between px-4 py-3 rounded-2xl" style={{ background: 'rgba(251,146,60,0.05)', border: '1px solid rgba(251,146,60,0.10)' }}>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col gap-3">
              {roles.map(({ role, desc }) => (
                <div key={role} className="p-5 rounded-2xl" style={{ background: 'rgba(251,146,60,0.05)', border: '1px solid rgba(251,146,60,0.10)' }}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                style={{ background: 'var(--contact-resume-bg)', color: 'var(--fg-55)', border: '1px solid var(--border-strong)' }}
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="btn-spring inline-flex items-center gap-2 font-sans text-sm font-semibold px-5 py-3 rounded-full transition-colors duration-150"
                style={{ background: 'rgba(37,99,235,0.12)', color: '#60a5fa', border: '1px solid rgba(37,99,235,0.30)' }}
              >
                GitHub ↗
              </a>
            </div>
