    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div>
            <p className="font-sans text-xs uppercase tracking-widest mb-0.5" style={{ color: 'var(--fg-30)' }}>Reymart Louie L. Capapas</p>
            <h2 className="font-display text-xl" style={{ color: 'var(--fg)' }}>Resume</h2>
          </div>
