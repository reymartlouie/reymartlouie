...
const socialLinks = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/reymart-louie-capapas-b0063718b",
  },
  ...
  return (
    <div className="flex flex-col items-center text-center gap-7 md:gap-9 pt-12 md:pt-20 px-1">
      ...
      <div>
        ...
        <p className="font-sans text-sm text-[#1e1e1e]/50 mt-3">
      ...
      <p className="font-sans text-xs uppercase tracking-widest text-[#1e1e1e]/35 pb-4 md:pb-8">
        University of St. La Salle · IT Officer @ Ubiquity Global Services ·
        Building since 2022
      </p>
