  ...
  return (
    <section className="flex flex-col gap-4">
      <div ref={ref} className="reveal-item flex flex-col gap-4">
        ...
        {/* Selected work */}
        <div className="rounded-[32px] overflow-hidden" style={{ background: 'var(--bg-card)' }}>
          ...
          <div className="p-4 lg:p-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(145deg, #1e1008 0%, #160c06 100%)',
            ...
            >
              <div className="px-6 md:px-8 pt-6 pb-5">
                ...
                <span className="inline-flex items-center gap-1.5 font-sans text-sm font-medium" style={{ color: 'rgba(251,146,60,0.85)' }}>
                  View Details →
                </span>
              </div>

              {/* Bottom: FireSafe logo */}
              <div className="relative overflow-hidden mt-auto" style={{ height: '192px' }}>
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, #160c06 0%, #1e1008 100%)' }} />
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(145deg, #08101e 0%, #060c18 100%)',
            ...
            >
              ...
              {/* Bottom: Gracey logo */}
              <div className="relative overflow-hidden mt-auto" style={{ height: '192px' }}>
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, #060c18 0%, #08101e 100%)' }} />
                <div className="absolute inset-0 flex items-center justify-center pb-10">
                  <img
